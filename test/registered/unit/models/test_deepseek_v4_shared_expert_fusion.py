...
class TestDeepseekV4SharedExpertFusionPolicy(unittest.TestCase):
    """The disable decision is a load-time resolution declared onto the config
    bag via declare_load_time_override."""
    ...
    def test_disables_shared_fusion_without_enforce(self):
        ...
        # the load-time declaration lands on the config bag (server_args stays
        # the pristine startup record)
